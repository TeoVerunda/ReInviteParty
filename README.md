...
A lightweight utility addon for raid leaders that automates the conversion of raids back into 5-man parties, with optional status feedback via CleveRoid
.
...
Prepare your group in raid mode.

Run /reinviteparty (or /reinvite / /reinv).
